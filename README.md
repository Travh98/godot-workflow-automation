...
You build materials in Godot. You want to see the Godot materials in blender. Install the `godot_material_sync.py` addon into Blender, point the addon to your Godot `.project` file and press sync. Blender will have copies of all of the materials from your Godot project inside of Blender, so your models in Blender will look exactly like how they will look in Godot.
